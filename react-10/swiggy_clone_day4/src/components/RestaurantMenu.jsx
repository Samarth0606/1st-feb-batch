...
function RestaurantMenu() {
    ...
    useEffect(()=>{
        async function calling() {
            let API = `https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=21.99740&lng=79.00110&restaurantId=${id}&catalog_qa=undefined&submitAction=ENTER`
            let resp = await axios.get(API);
            console.log(resp.data.data.cards[5].groupedCard.cardGroupMap.REGULAR.cards[1].card.card.itemCards , "resp");
